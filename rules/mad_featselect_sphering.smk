...
rule select_best_map_target2_mad_featselect_sphering:
    input:
        map_files=expand(
            "outputs/{{scenario}}/sphering/exploration/map_target2_mad_featselect_sphering_reg~{reg}.parquet",
            reg=reg_opts,
        ),
...
rule mad_featselect_sphering_job:
    input:
...
rule ap_target2_mad_featselect_sphering:
    input:
        "outputs/{scenario}/sphering/exploration/mad_featselect_sphering_reg~{reg}.parquet",
    output:
        "outputs/{scenario}/sphering/exploration/ap_target2_mad_featselect_sphering_reg~{reg}.parquet",
    params:
        plate_types=["TARGET2"],
    run:
...
rule map_target2_mad_featselect_sphering:
    input:
        "outputs/{scenario}/sphering/exploration/ap_target2_mad_featselect_sphering_reg~{reg}.parquet",
    output:
        "outputs/{scenario}/sphering/exploration/map_target2_mad_featselect_sphering_reg~{reg}.parquet",
