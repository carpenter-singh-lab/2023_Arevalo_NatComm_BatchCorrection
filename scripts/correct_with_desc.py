...
def correct_with_desc(dframe_path: str, batch_key: str, output_path: str, smoketest=False):
    '''DESC correction'''
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_data", required=True, help="Path to the input data file (Parquet format).")
    parser.add_argument("--batch_key", required=True, help="Batch key(s), separated by commas if multiple.")
    parser.add_argument("--output_path", required=True, help="Path to save the corrected output data.")
    parser.add_argument("--smoketest", action='store_true', help="Run a smoketest with reduced parameters.")
