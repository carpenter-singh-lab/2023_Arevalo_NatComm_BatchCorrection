...
if __name__ == "__main__":
    ...
    parser.add_argument("--epsilon", type=float, default=0.1, help="Regularization parameter for sphering")
    parser.add_argument("--column_norm", required=True, help="Column name to use for normalization")
    parser.add_argument("--values_norm", required=True, help="Values in column_norm to use for normalization, separated by spaces")
    parser.add_argument("--output_path", required=True, help="Path to save sphered data")
